/* global L */
import { iconTC, iconHanabi, iconTot, iconIj } from './config.js';
...
export function getIcon(ev, fav) {
  ...
  if (ev.source === 'ij') {
    return fav
      ? L.divIcon({ html: '<div class="m-ij m-fav"></div>',     className: '', iconSize: [16,16], iconAnchor: [8,8],   popupAnchor: [0,-12] })
      : iconIj;
  }
  return fav
